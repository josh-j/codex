...
**Source:** `community/vmware/plugins/modules/vmware_host_vmnic_info.py`
...
- `roles/esxi/tasks/collect.yaml:106`

## Other parameters

**`capabilities`**  *(bool, default: `False`)*
...
**`directpath_io`**  *(bool, default: `False`)*
