...
**Source:** `community/vmware/plugins/modules/vmware_datacenter_info.py`
...
- `playbooks/esxi_refresh_inventory.yml:25`
- `roles/common/tasks/discover_esxi.yaml:15`
- `roles/esxi/tasks/collect.yaml:22`
- `roles/vcsa/tasks/collect.yaml:40`
