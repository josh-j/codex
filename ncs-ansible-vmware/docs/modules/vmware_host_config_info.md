...
**Source:** `community/vmware/plugins/modules/vmware_host_config_info.py`
...
- `roles/esxi/tasks/maintain/password_rotate.yaml:38`
- `roles/esxi/tasks/maintain/password_status.yaml:12`
