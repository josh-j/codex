...
def _iter_vmware_hosts(aggregated_hosts: dict[str, Any]) -> list[tuple[str, dict[str, Any]]]:
    return _iter_hosts(aggregated_hosts)


def _coerce_vmware_bundle(bundle: Any) -> dict[str, Any]:
...
def _extract_vmware_inventory_summary(bundle_view: dict[str, Any]) -> dict[str, int]:
...
def _extract_vmware_utilization(bundle_view: dict[str, Any]) -> dict[str, dict[str, Any]]:
...
def _extract_vmware_version(bundle_view: dict[str, Any]) -> str:
    discovery = dict(bundle_view.get("discovery") or {})
...
def _extract_cluster_list(bundle_view: dict[str, Any]) -> list[dict[str, Any]]:
    discovery = dict(bundle_view.get("discovery") or {})
...
def _extract_appliance_health(bundle_view: dict[str, Any]) -> dict[str, dict[str, Any]]:
    discovery = dict(bundle_view.get("discovery") or {})
