...
def _simple_schema() -> ReportSchema:
    return ReportSchema(
        ...
        fields={
            ...
            "tag_csv": FieldSpec(path="tags | join_csv", type="str", fallback=""),
...
class TestFieldExtraction:
    ...
    def test_join_csv_transform(self) -> None:
        raw = {"tags": ["a", "b", "c"]}
        assert resolve_field("tags | join_csv", raw) == "a, b, c"
    ...
    def test_extract_fields_with_schema(self) -> None:
        ...
        assert fields["tag_csv"] == "prod, web"
...
class TestNormalizeFromSchema:
    def test_returns_standard_keys(self) -> None:
        ...
        assert "sections_meta" in result
