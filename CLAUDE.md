...
Codex is an Ansible-based infrastructure health monitoring and STIG compliance auditing system for heterogeneous fleets (Ubuntu Linux, VMware ESXi/vCenter, Windows). It generates HTML dashboards, STIG compliance reports (CKLB), and CSV exports. A standalone Python CLI (`ncs_reporter`) is being developed to decouple reporting from Ansible execution.
