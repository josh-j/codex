...
def linux_fleet_view(aggregated_hosts, report_stamp=None, report_date=None, report_id=None):
    return _build_linux_fleet_view(
        aggregated_hosts,
...
def linux_node_view(bundle, hostname=None, report_stamp=None, report_date=None, report_id=None):
    return _build_linux_node_view(
        hostname or "unknown",
        bundle,
        report_stamp=report_stamp,
        report_date=report_date,
