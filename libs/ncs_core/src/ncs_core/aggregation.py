...
from ncs_core.primitives import canonical_severity  # noqa: F401
    ...
    for root, dirs, files in os.walk(report_dir):
        ...
        for yaml_file in yaml_files:
            ...
            try:
                ...
                # FIX: Use deep_merge instead of assigning to [audit_type]
                # This combines discovery.yaml and vcenter.yaml into one object
...
def write_output(data: dict[str, Any], output_path: str | os.PathLike[str]) -> None:
    ...
    try:
        ...
        if isinstance(data, dict) and "hosts" in data:
            ...
            print(f"Success: Wrote data to {output_path}")
    except OSError as e:
