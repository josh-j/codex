...
def build_platform_entries_from_schemas(
    ...
    for schema in platform_schemas:
        ...
        primary: dict[str, Any] = {
            ...
            "stig_playbook": schema.stig.ansible.playbook,
            "stig_target_var": schema.stig.ansible.target_var,
        }
        ...
        for sub in spec.sub_entries:
            sub_entry: dict[str, Any] = {
                ...
                "stig_playbook": sub.stig_playbook or schema.stig.ansible.playbook,
                "stig_target_var": sub.stig_target_var or schema.stig.ansible.target_var,
            }
