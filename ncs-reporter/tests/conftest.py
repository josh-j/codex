...
built-in collection's ncs_configs/ tree.
...
_ORCH_DIR = REPO_ROOT / "ncs-ansible" / "ncs_configs"
_COLLECTION_DIRS = sorted(REPO_ROOT.glob("ncs-ansible-*/ncs_configs"))
...
class _MultiDirLookup:
    ...
    ncs_configs/ dir. Keeps the ergonomic ``CONFIGS_DIR / name``
